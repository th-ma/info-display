...
class ConfigWeather:
    ...
    REGION_OUTDOOR_HEIGHT: int  = 200 - REGION_DISTANCE
    # time date
    ...
    REGION_FORECAST_X: int      = 0 + REGION_BORDER
    REGION_FORECAST_Y: int      = REGION_TIME_DATE_Y + REGION_TIME_DATE_HEIGHT + REGION_DISTANCE+ REGION_DISTANCE
    REGION_FORECAST_WIDTH: int  = 1024 - REGION_BORDER - REGION_BORDER
    REGION_FORECAST_HEIGHT: int = 300 - REGION_DISTANCE
    # indoor
    REGION_INDOOR_NAME: str     = 'region_indoor'
    REGION_INDOOR_X: int        = REGION_DISTANCE + REGION_OUTDOOR_X + REGION_OUTDOOR_WIDTH + REGION_TIME_DATE_WIDTH + REGION_DISTANCE
